...
Since we assigned the results of `stratify()` to an object, that object can be passed into `recruit()`, which automatically learns information about the stratification process.
