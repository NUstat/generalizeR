...
Since we are working with high schools, we can use the Common Core database provided in this package. For information on each of the columns and the source of the data, run `?cc`.
