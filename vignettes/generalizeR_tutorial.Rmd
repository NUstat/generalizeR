...
```{r include = FALSE}
rec_output <- recruit(strat_output, guided = FALSE, number = 40)
```
...
<img src="sec_2_ex_1_fig_4.png" width="550"/>
...
<img src="sec_2_ex_1_fig_5.png" width="550"/>
