...
A similar table is also printed in the Viewer pane:

```{r echo = FALSE}
test$heat_data_kable
```

At this point, the function also prints a heat map:
...
We have completed the stratifying process! The next step is figuring out which units from these strata to recruit. 
