...
#'
#' The method used to generalize average treatment effect to the target population.  Default is "weighting" (weighting by participation probability)
#'
#' @param outcome variable name denoting outcome
#' @param treatment variable name denoting binary treatment assignment (okay if only available in trial, not population)
...
#' Formats and prints results from a `generalize` object generated by the `generalize()` function
#'
#' @param x generalize object, an object generated by the `generalize()` function
#' @export
...
#' Summarizes results from a `generalizer_assess` object generated by the `generalize()` function
#'
#' @param object generalize object, an object generated by the `generalize()` function
#' @return an object of class `summary.generalize`
#' @export
...
#' Formats and prints results from a `summary.generalize` object generated by the `summary.generalize()` function
#'
#' @param x summary.generalize object, an object generated by the `summary.generalize()` function
#' @export
