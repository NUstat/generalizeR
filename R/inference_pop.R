#' CCD (Subset of Common Core of Data), 2017
#'
...
#'
#' This dataset corresponds to the year 2017. It is a compilation of variables downloaded from the data files at https://nces.ed.gov/ccd/. It attempts to cover most demographic variables about the schools. This specific dataset has information on Texas charter high schools for the vignette.
#'
...
#'
#' @format A data frame with 330 rows and 44 columns. Each row corresponds to an institution.
#'
#' \describe{
